...
var n=r(/*! ./util */5),o=n.AssertionError,i=n.inspect,s=function(t){return new a(n.isWrapperType(t)?t.valueOf():t)},a=s.Assertion=function(t){this.obj=t};a.add=function(t,e,r){var n={enumerable:!0};n[r?"get":"value"]=function(){var t=new a(this.obj);t.copy=t.copyIfMissing,t.anyOne=this.anyOne;try{e.apply(t,arguments)}catch(r){if(this.copy(t),r instanceof s.AssertionError){if(this.negate)return this.obj=t.obj,this.negate=!1,this;this.assert(!1)}throw r}return this.copy(t),this.negate&&this.assert(!1),this.obj=t.obj,this.negate=!1,this},Object.defineProperty(a.prototype,t,n)},a.alias=function(t,e){var r=Object.getOwnPropertyDescriptor(a.prototype,t);if(!r)throw new Error("Alias "+t+" -> "+e+" could not be created as "+t+" not defined");Object.defineProperty(a.prototype,e,r)},s.AssertionError=o,s.format=function(t){return n.isDate(t)&&"function"!=typeof t.inspect?t.toISOString():i(t,{depth:null})},s.use=function(t){return t(this,a),this},e=t.exports=s,Object.defineProperty(Object.prototype,"should",{set:function(){},get:function(){return s(this)},configurable:!0}),a.prototype={constructor:a,assert:function(t){if(t)return this;var e=this.params,r=e.message,n=!1;r||(r=this.getMessage(),n=!0);var i=new o({message:r,actual:this.obj,expected:e.expected,stackStartFunction:this.assert});throw i.showDiff=e.showDiff,i.operator=e.operator,i.generatedMessage=n,i},getMessage:function(){return"expected "+("obj"in this.params?this.params.obj:s.format(this.obj))+(this.negate?" not ":" ")+this.params.operator+("expected"in this.params?" "+s.format(this.params.expected):"")},copy:function(t){this.params=t.params},copyIfMissing:function(t){this.params||(this.params=t.params)},get not(){return this.negate=!this.negate,this},get any(){return this.anyOne=!0,this}},s.use(r(/*! ./ext/assert */6)).use(r(/*! ./ext/chain */7)).use(r(/*! ./ext/bool */8)).use(r(/*! ./ext/number */9)).use(r(/*! ./ext/eql */10)).use(r(/*! ./ext/type */11)).use(r(/*! ./ext/string */12)).use(r(/*! ./ext/property */13)).use(r(/*! ./ext/error */14)).use(r(/*! ./ext/match */15)).use(r(/*! ./ext/contain */16))},/*!**************************************!*\
  ...
  \**************************************/
function(t,e,r){function n(t){return f(t)&&(t.__ArrayLike||Array.isArray(t))}function o(t){return"number"==typeof t||t instanceof Number}function i(t){return"string"==typeof t||t instanceof String}function s(t){return"boolean"==typeof t||t instanceof Boolean}function a(t){return"undefined"!=typeof Buffer&&t instanceof Buffer}function u(t){return f(t)&&"[object Date]"===c(t)}function c(t){return Object.prototype.toString.call(t)}function f(t){return"object"==typeof t&&null!==t}function l(t){return f(t)&&"[object RegExp]"===c(t)}function p(t){return null==t}function h(t){return null===t}function d(t){return"[object Arguments]"===c(t)}function m(t){return f(t)&&"[object Error]"===c(t)||t instanceof Error}function g(t){return void 0===t}/*!
	 * Should
	 * Copyright(c) 2010-2014 TJ Holowaychuk <tj@vision-media.ca>
	 * MIT Licensed
	 */
e.isWrapperType=function(t){return o(t)||i(t)||s(t)},e.merge=function(t,e){if(t&&e)for(var r in e)t[r]=e[r];return t},e.isArray=n,e.isNumber=o,e.isBoolean=s,e.isString=i,e.isBuffer=a,e.isDate=u,e.isObject=f,e.isRegExp=l,e.isNullOrUndefined=p,e.isNull=h,e.isArguments=d,e.isFunction=function(t){return"function"==typeof t||t instanceof Function},e.isError=m,e.isUndefined=g,e.inspect=r(/*! ./inspect */18).inspect,e.AssertionError=r(/*! assert */17).AssertionError;var b=Object.prototype.hasOwnProperty;e.forOwn=function(t,e,r){for(var n in t)b.call(t,n)&&e.call(r,t[n],n)};var y=/^\s*function\s*(\S*)\s*\(/;e.functionName=function(t){if(t.name)return t.name;var e=t.toString().match(y)[1];return e},e.formatProp=function(t){return t=JSON.stringify(""+t),t=t.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/)?t.substr(1,t.length-2):t.replace(/'/g,"\\'").replace(/\\"/g,'"').replace(/(^"|"$)/g,"'").replace(/\\\\/g,"\\")}},/*!********************************************!*\
...
function(t){t.exports=require("assert")},/*!*****************************************!*\
  ...
  \*****************************************/
function(t,e,r){function n(t,r){var n={seen:[],stylize:i};return arguments.length>=3&&(n.depth=arguments[2]),arguments.length>=4&&(n.colors=arguments[3]),g(r)?n.showHidden=r:r&&e._extend(n,r),y(n.showHidden)&&(n.showHidden=!1),y(n.depth)&&(n.depth=2),y(n.colors)&&(n.colors=!1),y(n.customInspect)&&(n.customInspect=!0),n.colors&&(n.stylize=o),a(n,t,n.depth)}function o(t,e){var r=n.styles[e];return r?"["+n.colors[r][0]+"m"+t+"["+n.colors[r][1]+"m":t}function i(t){return t}function s(t){var e={};return t.forEach(function(t){e[t]=!0}),e}function a(t,r,n){if(t.customInspect&&r&&v(r.inspect)&&r.inspect!==e.inspect&&(!r.constructor||r.constructor.prototype!==r)){var o=r.inspect(n,t);return j(o)||(o=a(t,o,n)),o}var i=u(t,r);if(i)return i;var d=Object.keys(r),m=s(d);t.showHidden&&(d=Object.getOwnPropertyNames(r));var b,y=r;try{E(r)||(y=r.valueOf())}catch(O){}if(j(y)&&(d=d.filter(function(t){return!(t>=0&&t<y.length)})),A(r))return f(r);if(0===d.length){if(v(r)){var q=r.name?": "+r.name:"";return t.stylize("[Function"+q+"]","special")}if(w(r))return t.stylize(RegExp.prototype.toString.call(r),"regexp");if(E(r))return t.stylize(Date.prototype.toString.call(r),"date");if(j(y))return b=c(t,y),t.stylize("[String: "+b+"]","string");if(x(y))return b=c(t,y),t.stylize("[Number: "+b+"]","number");if(g(y))return b=c(t,y),t.stylize("[Boolean: "+b+"]","boolean")}var k="",N=!1,P=["{","}"];if(S(r)&&(N=!0,P=["[","]"]),v(r)){var z=r.name?": "+r.name:"";k=" [Function"+z+"]"}if(w(r)&&(k=" "+RegExp.prototype.toString.call(r)),E(r)&&(k=" "+Date.prototype.toUTCString.call(r)),A(r)&&(k=" "+f(r)),j(y)&&(b=c(t,y),k=" [String: "+b+"]"),x(y)&&(b=c(t,y),k=" [Number: "+b+"]"),g(y)&&(b=c(t,y),k=" [Boolean: "+b+"]"),0===d.length&&(!N||0===r.length))return P[0]+k+P[1];if(0>n)return w(r)?t.stylize(RegExp.prototype.toString.call(r),"regexp"):t.stylize("[Object]","special");t.seen.push(r);var _;return _=N?l(t,r,n,m,d):d.map(function(e){return p(t,r,n,m,e,N)}),t.seen.pop(),h(_,k,P)}function u(t,e){if(y(e))return t.stylize("undefined","undefined");if(j(e)){var r="'"+JSON.stringify(e).replace(/^"|"$/g,"").replace(/'/g,"\\'").replace(/\\"/g,'"')+"'";return t.stylize(r,"string")}return x(e)?0===e&&0>1/e?t.stylize("-0","number"):t.stylize(""+e,"number"):g(e)?t.stylize(""+e,"boolean"):O(e)?t.stylize("null","null"):void 0}function c(t,e){var r=t.stylize;t.stylize=i;var n=u(t,e);return t.stylize=r,n}function f(t){return"["+Error.prototype.toString.call(t)+"]"}function l(t,e,r,n,o){for(var i=[],s=0,a=e.length;a>s;++s)i.push(d(e,String(s))?p(t,e,r,n,String(s),!0):"");return o.forEach(function(o){o.match(/^\d+$/)||i.push(p(t,e,r,n,o,!0))}),i}function p(t,e,r,n,o,i){var s,u,c;if(c=Object.getOwnPropertyDescriptor(e,o)||{value:e[o]},c.get?u=c.set?t.stylize("[Getter/Setter]","special"):t.stylize("[Getter]","special"):c.set&&(u=t.stylize("[Setter]","special")),d(n,o)||(s="["+o+"]"),u||(t.seen.indexOf(c.value)<0?(u=O(r)?a(t,c.value,null):a(t,c.value,r-1),u.indexOf("\n")>-1&&(u=i?u.split("\n").map(function(t){return" "+t}).join("\n").substr(2):"\n"+u.split("\n").map(function(t){return" "+t}).join("\n"))):u=t.stylize("[Circular]","special")),y(s)){if(i&&o.match(/^\d+$/))return u;s=JSON.stringify(""+o),s.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/)?(s=s.substr(1,s.length-2),s=t.stylize(s,"name")):(s=s.replace(/'/g,"\\'").replace(/\\"/g,'"').replace(/(^"|"$)/g,"'").replace(/\\\\/g,"\\"),s=t.stylize(s,"string"))}return s+": "+u}function h(t,e,r){var n=t.reduce(function(t,e){return t+e.replace(/\u001b\[\d\d?m/g,"").length+1},0);return n>60?r[0]+(""===e?"":e+"\n ")+" "+t.join(",\n ")+" "+r[1]:r[0]+e+" "+t.join(", ")+" "+r[1]}function d(t,e){return Object.prototype.hasOwnProperty.call(t,e)}var m=r(/*! ./util */5),g=m.isBoolean,b=m.isObject,y=m.isUndefined,v=m.isFunction,j=m.isString,x=m.isNumber,O=m.isNull,w=m.isRegExp,E=m.isDate,A=m.isError,S=m.isArray;e.inspect=n,n.colors={bold:[1,22],italic:[3,23],underline:[4,24],inverse:[7,27],white:[37,39],grey:[90,39],black:[30,39],blue:[34,39],cyan:[36,39],green:[32,39],magenta:[35,39],red:[31,39],yellow:[33,39]},n.styles={special:"cyan",number:"yellow","boolean":"yellow",undefined:"grey","null":"bold",string:"green",date:"magenta",regexp:"red"},e._extend=function(t,e){if(!e||!b(e))return t;for(var r=Object.keys(e),n=r.length;n--;)t[r[n]]=e[r[n]];return t}},/*!*************************************!*\
