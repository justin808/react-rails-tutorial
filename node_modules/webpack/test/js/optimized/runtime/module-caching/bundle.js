!function(t){function e(n){if(r[n])return r[n].exports;var o=r[n]={exports:{},id:n,loaded:!1};return t[n].call(o.exports,o,o.exports,e),o.loaded=!0,o.exports}var r={},n={0:1};return e.e=function(r,o){if(1===n[r])o.call(null,e);else if(n[r])n[r].push(o);else{n[r]=[o];var i=__dirname+"/"+r+".bundle.js";require("fs").readFile(i,"utf-8",function(r,o){if(r){if(e.onError)return e.onError(r);throw r}var s={};require("vm").runInThisContext("(function(exports, require, __dirname, __filename) {"+o+"\n})",i)(s,require,require("path").dirname(i),i);var a=s.modules,u=s.ids;for(var c in a)t[c]=a[c];for(var l=[],f=0;f<u.length;f++)Array.isArray(n[u[f]])&&(l=l.concat(n[u[f]])),n[u[f]]=1;for(f=0;f<l.length;f++)l[f].call(null,e)})}},e.m=t,e.c=r,e.p="",e(0)}([/*!*****************************************!*\
  ...
  \*****************************************/
function(t,e,r){r(/*! should */18);it("should cache modules correctly",function(t){delete r.c[2],r(/*! ./singluar.js */2).value.should.be.eql(1),r(/*! ./singluar.js */2).value.should.be.eql(1),r(/*! ./singluar.js */2).value=2,r(/*! ./singluar.js */2).value.should.be.eql(2),r.e(1,function(){r(/*! ./singluar.js */2).value.should.be.eql(2),t()})}),it("should be able the remove modules from cache with require.cache and require.resolve",function(){var t=r(/*! ./singluar2 */4),e=4,n=4;e.should.have.type("number"),n.should.be.eql(e),r.c.should.have.type("object"),r.c[e].should.have.type("object"),delete r.c[e],r(/*! ./singluar2 */4).should.be.not.equal(t)})},/*!**************************************!*\
...
function(t,e,r){/*!
	 ...
	 * MIT Licensed
	 */
var n=r(/*! ../eql */3);t.exports=function(t,e){e.add("eql",function(t,e){this.params={operator:"to equal",expected:t,showDiff:!0,message:e},this.assert(n(t,this.obj))}),e.add("equal",function(t,e){this.params={operator:"to be",expected:t,showDiff:!0,message:e},this.assert(t===this.obj)}),e.alias("equal","exactly")}},/*!*******************************************!*\
